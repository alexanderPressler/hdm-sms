...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "report" because\n';
  ...
  $wnd.__gwt_activeModules['report'] = {
    'moduleName' : 'report',
    'bindings' : function() {
      return {};
    }
 ...
 * "/report.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['report'].superdevmode = true;

  var expectedSuffix = '/report.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + report + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:report';
  var devModeSessionKey = '__gwtDevModeSession:report';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/report/report.nocache.js';
  ...
  $wnd.__gwt_activeModules['report'].canRedirect = true;
  $wnd.__gwt_activeModules['report'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/report?user.agent=' + ua + '&_callback=' + callback;
