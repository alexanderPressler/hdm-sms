...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "de.hdm.gruppe1.HdM_smsReport" because\n';
  ...
  $wnd.__gwt_activeModules['de.hdm.gruppe1.HdM_smsReport'] = {
    'moduleName' : 'de.hdm.gruppe1.HdM_smsReport',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/de.hdm.gruppe1.HdM_smsReport.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['de.hdm.gruppe1.HdM_smsReport'].superdevmode = true;

  var expectedSuffix = '/de.hdm.gruppe1.HdM_smsReport.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + de.hdm.gruppe1.HdM_smsReport + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:de.hdm.gruppe1.HdM_smsReport';
  var devModeSessionKey = '__gwtDevModeSession:de.hdm.gruppe1.HdM_smsReport';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/de.hdm.gruppe1.HdM_smsReport/de.hdm.gruppe1.HdM_smsReport.nocache.js';
  ...
  $wnd.__gwt_activeModules['de.hdm.gruppe1.HdM_smsReport'].canRedirect = true;
  $wnd.__gwt_activeModules['de.hdm.gruppe1.HdM_smsReport'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING de.hdm.gruppe1.HdM_smsReport';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/de.hdm.gruppe1.HdM_smsReport?user.agent=' + ua + '&_callback=' + callback;
