...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "hdm_sms" because\n';
  ...
  $wnd.__gwt_activeModules['hdm_sms'] = {
    'moduleName' : 'hdm_sms',
    'bindings' : function() {
      return {};
    }
 ...
 * "/hdm_sms.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['hdm_sms'].superdevmode = true;

  var expectedSuffix = '/hdm_sms.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + hdm_sms + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:hdm_sms';
  var devModeSessionKey = '__gwtDevModeSession:hdm_sms';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/hdm_sms/hdm_sms.nocache.js';
  ...
  $wnd.__gwt_activeModules['hdm_sms'].canRedirect = true;
  $wnd.__gwt_activeModules['hdm_sms'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/hdm_sms?user.agent=' + ua + '&_callback=' + callback;
