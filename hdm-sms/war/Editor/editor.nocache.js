...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "editor" because\n';
  ...
  $wnd.__gwt_activeModules['editor'] = {
    'moduleName' : 'editor',
    'bindings' : function() {
      return {};
    }
 ...
 * "/editor.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['editor'].superdevmode = true;

  var expectedSuffix = '/editor.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + editor + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:editor';
  var devModeSessionKey = '__gwtDevModeSession:editor';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/editor/editor.nocache.js';
  ...
  $wnd.__gwt_activeModules['editor'].canRedirect = true;
  $wnd.__gwt_activeModules['editor'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/editor?user.agent=' + ua + '&_callback=' + callback;
