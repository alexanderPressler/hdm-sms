...
/**
 * Die Klasse CreateStueckliste erm�glicht dem User, Objekte von St�ckliste in der Datenbank anzulegen.
 * 
...
public class CreateStueckliste extends VerticalPanel {
	...
	private final Label SublineLabel = new Label ("Um eine Stückliste anzulegen, f�llen Sie bitte alle Felder aus und best�tigen mit dem <anlegen>-Button ihre Eingabe.");
