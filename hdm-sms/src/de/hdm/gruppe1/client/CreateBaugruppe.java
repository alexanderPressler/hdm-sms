		...
		// TextBoxen werden mit Text vorbefüllt, der ausgeblendet wird, sobald
			...
			collectBgButton.addClickHandler(new ClickHandler() {
				public void onClick(ClickEvent event) {
					...
					// Der Tabelle wird ein Objekt von ElementPaar hinzugefügt,
					// welches in den folgenden Zeilen befüllt wird xxxxxxxxxxxxxxxxNEU
					...
					// erstellte ElementPaar hinzugefügt xxxxxxxxxxxxxxxNEU
...
*/
	...
	/**
	 * Hiermit wird die RPC-Methode aufgerufen, die ein Baugruppen-Objekt und eine Stueckliste in
	...
	private class CreateClickHandler implements ClickHandler {
		...
		public void onClick(ClickEvent event) {
			...
			if (NameField.getText().isEmpty() != true) {
				 ...
				 * mitgeschickt.
				 */
				String nameBaugruppe = NameField.getText();
				Stueckliste stueckliste = new Stueckliste ();
				stueckliste.setBauteilPaare(collectBauteile);
				stueckliste.setName(NameField.getText() + "_sl");
//				stueckliste.setBaugruppenPaare(collectBaugruppen);
				
				stuecklistenVerwaltung.createBaugruppe (nameBaugruppe,
						stueckliste, 
