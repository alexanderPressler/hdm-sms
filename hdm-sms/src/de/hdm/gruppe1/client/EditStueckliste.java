...
//Die Klasse EditStueckliste liefert alle ben�tigten Elemente, um eine bestehende St�ckliste im System zu �ndern.
public class EditStueckliste extends VerticalPanel {
	
	//Elemente f�r EditStueckliste initialisieren
	private final Label HeadlineLabel = new Label ("Stückliste �ndern");
	private final Label SublineLabel = new Label ("Um eine Stückliste zu ändern, füllen Sie bitte alle Felder aus und bestütigen mit dem <editieren>-Button ihre Eingabe.");
...
//	
	...
	/**
	  * Das �ndern einer St�ckliste ruft die Service-Methode "edit" auf.
	  * 
	  */
