...
public abstract class BusinessObject implements Serializable {
	...
	/**
	 * @author thies Erzeugen einer einfachen textuellen Darstellung der
	 *         jeweiligen Instanz. Dies kann selbstverständlich in Subklassen
	 ...
	 * <p>
	 * 
	 * @author thies Feststellen der <em>inhaltlichen</em> Gleichheit zweier
	 *         <code>BusinessObject</code>-Objekte. Die Gleichheit wird in
	 *         diesem Beispiel auf eine identische ID beschränkt.
	 *         </p>
	 *         <p>
	 *         <b>ACHTUNG:</b> Die inhaltliche Gleichheit nicht mit dem
	 *         Vergleich der <em>Identität</em> eines Objekts mit einem anderen
	 *         verwechseln!!! Dies würde durch den Operator <code>==</code>
	 *         bestimmt. Bei Unklarheit hierzu können Sie nocheinmal in die
	 *         Definition des Sprachkerns von Java schauen. Die Methode
	 *         <code>equals(...)</code> ist für jeden Referenzdatentyp
	 *         definiert, da sie bereits in der Klasse <code>Object</code> in
	 *         einfachster Form realisiert ist. Dort ist sie allerdings auf die
	 *         simple Bestimmung der Gleicheit der Java-internen Objekt-ID der
	 *         verglichenen Objekte beschränkt. In unseren eigenen Klassen
	 *         können wir diese Methode überschreiben und ihr mehr Intelligenz
	 *         verleihen.
	 *         </p>
	 */
	
	/** (@override)- Mit diesem Typ kann eine Methode gekennzeichnet werden, 
	 * die die Methode ihrer Oberklasse überschreibt. Der Compiler stellt dann 
	 * sicher, dass die  Oberklasse diese Methode enthält und gibt einen Fehler 
