...
import de.hdm.gruppe1.shared.report.CompositeParagraph;
/**
...
public class HTMLReportWriter extends ReportWriter {
	...
	private static final String CompositeParagraph = null;
	/**
	 ...
	 */
	   public String paragraph2HTML(Paragraph p) {
		   if(p.getClass().isInstance(CompositeParagraph)) {
	 ...
	 */
	public void process(MaterialBedarfReport r) {
	 ...
	 *            der zu prozessierende Report
	 */
	public void process(StrukturStuecklisteReport r) {
		   this.resetReportText();
